...
const ProductDetail = () => {
  ...
  const handlePrev = () => {
    setCurrentIndex(prev => (prev === 0 ? 2 : prev - 1)); // Retourne à l'image 2 si on est sur l'image 0
  };

  const handleNext = () => {
    setCurrentIndex(prev => (prev === 2 ? 0 : prev + 1)); // Repart à l'image 0 si on est sur l'image 2
  };
  ...
  return (
    <div className="container-fluid py-5" style={{ maxWidth: '1200px' }}>
      <div className="row gx-5" style={{ minHeight: '90vh' }}>
        {/* Colonne gauche : Image principale + Description */}
        <div className="col-md-6 d-flex flex-column">
          ...
          <div className="flex-fill rounded d-flex flex-column me-3">
            ...
            <div className="d-flex justify-content-center align-items-center mt-3" style={{ position: 'relative', left: '-100px' }}>
              <button className="btn btn-outline-secondary rounded-circle me-2" onClick={handlePrev}>
                &lt;
              </button>
              <span className="mx-5">
              ...
              <button className="btn btn-outline-secondary rounded-circle ms-2" onClick={handleNext}>
                &gt;
              </button>
            </div>
          </div>
          ...
          {/* Section Description */}
          <div className="flex-fill rounded bg-white overflow-auto">
            <h4 className="fw-bold mb-3">Description</h4>
            <div className="border-top my-3"></div>
            <div style={{ lineHeight: '1.6' }}>
              <p>
                Energize your look with a fresh take on heritage adidas <br />
        ...
        {/* Colonne droite : Détails produit + Image secondaire */}
        <div className="col-md-6 d-flex flex-column gap-3">
          ...
          <div className="flex-fill shadow p-3 rounded bg-white">
            ...
            <h3 className="text-muted mb-3">{product.description}</h3>
            <h3 className="text-uppercase">{product.nom}</h3>
            ...
            <button className="btn btn-dark w-100 py-3 mt-3 fw-bold">Add to Cart</button>
          </div>

          {/* Section Image secondaire */}
